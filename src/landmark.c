...
static const u8 LandmarkName_FlowerShop[] = _("{CHN}花店");
static const u8 LandmarkName_PetalburgWoods[] = _("{CHN}橙华森林");
static const u8 LandmarkName_MrBrineysCottage[] = _("{CHN}海大叔的小屋");
static const u8 LandmarkName_AbandonedShip[] = _("{CHN}弃船");
static const u8 LandmarkName_SeashoreHouse[] = _("{CHN}海滨小屋");
static const u8 LandmarkName_SlateportBeach[] = _("{CHN}凯那市海滩");
static const u8 LandmarkName_CyclingRoad[] = _("{CHN}自行车道");
static const u8 LandmarkName_NewMauville[] = _("{CHN}新紫堇");
static const u8 LandmarkName_TrickHouse[] = _("{CHN}欺诈屋");
static const u8 LandmarkName_OldLadysRestShop[] = _("{CHN}老妇人的休息处");
static const u8 LandmarkName_Desert[] = _("{CHN}沙漠");
static const u8 LandmarkName_WinstrateFamily[] = _("{CHN}胜利家族");
static const u8 LandmarkName_CableCar[] = _("{CHN}缆车");
static const u8 LandmarkName_GlassWorkshop[] = _("{CHN}玻璃工房");
static const u8 LandmarkName_WeatherInstitute[] = _("{CHN}天气研究所");
static const u8 LandmarkName_MeteorFalls[] = _("{CHN}流星瀑布");
static const u8 LandmarkName_TunnelersRestHouse[] = _("{CHN}隧道工的休息处");
static const u8 LandmarkName_RusturfTunnel[] = _("{CHN}卡绿隧道");
static const u8 LandmarkName_PokemonDayCare[] = _("{CHN}宝可梦寄养屋");
static const u8 LandmarkName_SafariZoneEntrance[] = _("{CHN}狩猎地带入口");
static const u8 LandmarkName_MtPyre[] = _("{CHN}送火山");
static const u8 LandmarkName_ShoalCave[] = _("{CHN}浅滩洞穴");
static const u8 LandmarkName_SeafloorCavern[] = _("{CHN}海底洞窟");
static const u8 LandmarkName_GraniteCave[] = _("{CHN}石之洞窟");
static const u8 LandmarkName_OceanCurrent[] = _("{CHN}洋流");
static const u8 LandmarkName_LanettesHouse[] = _("{CHN}莲娜的小屋");
static const u8 LandmarkName_FieryPath[] = _("{CHN}烈焰小径");
static const u8 LandmarkName_JaggedPass[] = _("{CHN}崎岖山路");
static const u8 LandmarkName_SkyPillar[] = _("{CHN}天空之柱");
static const u8 LandmarkName_BerryMastersHouse[] = _("{CHN}树果名人之家");
static const u8 LandmarkName_IslandCave[] = _("{CHN}小岛洞穴");
static const u8 LandmarkName_DesertRuins[] = _("{CHN}沙漠遗迹");
static const u8 LandmarkName_ScorchedSlab[] = _("{CHN}焦枯石板");
static const u8 LandmarkName_AncientTomb[] = _("{CHN}古代坟墓");
static const u8 LandmarkName_SealedChamber[] = _("{CHN}封印之间");
static const u8 LandmarkName_FossilManiacsHouse[] = _("{CHN}化石狂之家");
static const u8 LandmarkName_HuntersHouse[] = _("{CHN}猎人之家");
static const u8 LandmarkName_MagmaHideout[] = _("{CHN}熔岩队藏身处");
static const u8 LandmarkName_MirageTower[] = _("{CHN}海市蜃楼塔");
static const u8 LandmarkName_AlteringCave[] = _("{CHN}变化洞穴");
static const u8 LandmarkName_DesertUnderpass[] = _("{CHN}沙漠地下道");
static const u8 LandmarkName_TrainerHill[] = _("{CHN}训练家之丘");
