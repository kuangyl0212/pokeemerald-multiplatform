...
static const u8 sText_PyramidFloor1[] = _("{CHN}金字塔1层");
static const u8 sText_PyramidFloor2[] = _("{CHN}金字塔2层");
static const u8 sText_PyramidFloor3[] = _("{CHN}金字塔3层");
static const u8 sText_PyramidFloor4[] = _("{CHN}金字塔4层");
static const u8 sText_PyramidFloor5[] = _("{CHN}金字塔5层");
static const u8 sText_PyramidFloor6[] = _("{CHN}金字塔6层");
static const u8 sText_PyramidFloor7[] = _("{CHN}金字塔7层");
static const u8 sText_Pyramid[] = _("{CHN}金字塔");
