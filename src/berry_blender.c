...
static const u8 sText_BerryBlenderStart[] = _("{CHN}树果搅拌机启动。\p请从背包中选择一个树果\n放入树果搅拌机。\p");
static const u8 sText_NewParagraph[] = _("\p");
static const u8 sText_WasMade[] = _("{CHN}制作完成！");
static const u8 sText_Mister[] = _("{CHN}先生");
static const u8 sText_Laddie[] = _("{CHN}小伙子");
static const u8 sText_Lassie[] = _("{CHN}小姑娘");
static const u8 sText_Master[] = _("{CHN}大师");
static const u8 sText_Dude[] = _("{CHN}老兄");
static const u8 sText_Miss[] = _("{CHN}小姐");
...
static const u8 sText_PressAToStart[] = _("{CHN}按A键开始。");
static const u8 sText_PleaseWaitAWhile[] = _("{CHN}请稍等片刻。");
static const u8 sText_CommunicationStandby[] = _("{CHN}通讯待机中……");
static const u8 sText_WouldLikeToBlendAnotherBerry[] = _("{CHN}还要再搅拌一个树果吗？");
static const u8 sText_RunOutOfBerriesForBlending[] = _("{CHN}树果搅拌机中\n没有可搅拌的树果了。\p");
static const u8 sText_YourPokeblockCaseIsFull[] = _("{CHN}你的{POKEBLOCK}盒已满。\p");
static const u8 sText_HasNoBerriesToPut[] = _("{CHN}没有可放入树果搅拌机\n的树果了。");
static const u8 sText_ApostropheSPokeblockCaseIsFull[] = _("{CHN}的{POKEBLOCK}盒已满。\p");
static const u8 sText_BlendingResults[] = _("{CHN}搅拌结果");
static const u8 sText_BerryUsed[] = _("{CHN}使用的树果");
static const u8 sText_SpaceBerry[] = _("{CHN} 树果");
static const u8 sText_Time[] = _("{CHN}时间：");
static const u8 sText_Min[] = _("{CHN}分");
static const u8 sText_Sec[] = _("{CHN}秒");
static const u8 sText_MaximumSpeed[] = _("{CHN}最高速度");
static const u8 sText_RPM[] = _("{CHN} RPM");
static const u8 sText_Dot[] = _(".");
static const u8 sText_NewLine[] = _("\n");
static const u8 sText_Space[] = _(" ");
static const u8 sText_Ranking[] = _("{CHN}排名");
static const u8 sText_TheLevelIs[] = _("{CHN}等级是");
static const u8 sText_TheFeelIs[] = _("{CHN}，触感是");
