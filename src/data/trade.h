...
static const u8 sText_IsThisTradeOkay[] = _("{CHN}这样交换可以吗？");
static const u8 sText_Cancel[] = _("{CHN}取消");
static const u8 sText_ChooseAPkmn[] = _("Choose a POKéMON.");
static const u8 sText_Summary[] = _("{CHN}查看资料");
static const u8 sText_Trade[] = _("{CHN}交换");
static const u8 sText_CancelTrade[] = _("{CHN}取消交换？");
